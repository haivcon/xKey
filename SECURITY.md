...
## Current Release Security Notes: v6.0.9

v6.0.9 is a synchronized web and Android release. It updates release documentation, package metadata, and Android build metadata without changing the local-only custody model by default.
...
- </details>
- Android metadata is updated to `versionCode 107` and `versionName 6.0.9`.
