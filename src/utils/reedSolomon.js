...
const buildMatrix = (dataShards, parityShards) => {
  const rows = [];
...
export const encodeReedSolomon = (bytes, options = {}) => {
...
export const decodeReedSolomon = ({ shards, present, dataShards, parityShards, originalLength }) => {
