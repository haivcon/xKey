...
const SecureDisplayContext = createContext(null);

export function useSecureDisplay() {
...
export function SecureDisplayProvider({ children }) {
  ...
  const remapToSessionGlyphs = useCallback((value) => (
