    ...
    <>
      ...
      <div className="border-b border-surface-700/30">
        <div className="flex items-start justify-between gap-3 p-4">
          ...
          >
            <KeyRound size={16} className={`mt-1 flex-shrink-0 ${mp.hasMasterPassword ? 'text-brand-400' : 'text-surface-400'}`} />
            <div className="min-w-0">
              <span className="block text-sm font-semibold text-white">{t('settings.masterPassword')}</span>
              <span className="mt-1 block text-xs leading-relaxed text-surface-500">{mp.hasMasterPassword ? t('settings.masterPasswordSummaryOn') : t('settings.masterPasswordSummaryOff')}</span>
            </div>
          </button>
        ...
        {showMasterPasswordDetails && (
          <div className="mx-4 mb-4 space-y-3 rounded-xl border border-surface-700/70 bg-surface-900/60 p-3">
            <div>
