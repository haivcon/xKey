...
export default function PinLockScreen({ onSuccess, onSelfDestruct }) {
  const t = useT();
  const [pin, setPin] = useState('');
  const [confirmPin, setConfirmPin] = useState('');
  const [mode, setMode] = useState('loading'); // loading | create | confirm | verify
  ...
  const applyLockout = async (attempts) => {
