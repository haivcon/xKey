...
export default function BulkNetworkModal({ onClose, onSave, walletCount }) {
      ...
      <div className="bg-surface-900 border border-surface-700 w-full max-w-sm rounded-2xl shadow-2xl flex flex-col overflow-hidden">
        ...
        <div className="p-5 space-y-4">
          <p className="text-sm text-surface-400">
            {t('actionBar.bulkNetworkDesc', { count: walletCount }) || `Select a new network for the ${walletCount} currently filtered wallet(s).`}
          </p>
