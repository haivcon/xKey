...
type SecureGlyphTextProps = {
  value: unknown;
  className?: string;
  multiline?: boolean;
};

export default function SecureGlyphText({ value, className = '', multiline = false }: SecureGlyphTextProps) {
...
const wrapSensitiveText = (ctx: CanvasRenderingContext2D, text: unknown, maxWidth: number): string[] => {
